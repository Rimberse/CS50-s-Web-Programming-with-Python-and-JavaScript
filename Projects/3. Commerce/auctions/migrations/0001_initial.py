    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('NO', 'No Category'), ('FS', 'Fashion'), ('TY', 'Toys'), ('ET', 'Electronics'), ('HM', 'Home'), ('MI', 'Magic Item'), ('VH', 'Vehicle')], default='NO', max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='active_listings', to='auctions.listing')),
            ],
        ),
        migrations.CreateModel(
            name='Watchlist',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('creator', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='creators', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            options={
                'unique_together': {('text', 'listing', 'author')},
            },
        ),
        migrations.CreateModel(
            name='Archive',
            fields=[
                ...
                ('listing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auction_listings', to='auctions.listing')),
